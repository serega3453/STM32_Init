...
extern volatile uint8_t exti4_flag;  /* PA4 (Safe mode reset) interrupt occurred */
extern volatile uint8_t exti5_flag;  /* PA5 (Hard safe mode input) interrupt occurred */
