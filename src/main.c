...
int main(void)
{
    ...
    */
    flag = 0b00000010;  //Safe mode enable, LED cycling off
    ...
    Color_Selector(0x05);   //Ligth solid YELLOW LED
    ...
    for(;(flag >> 1) == 0;) 
    {
        if (exti0_flag) {
            ...
            if (mpu_detect_impact(MPU_ADDR, impact_sensitivity)) 
            {
                ...
                flag = 0b00000000;                  //Stop LED cycling
